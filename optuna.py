...
if __name__ == "__main__":
    ...
    attack_parameter_dict = {"fgsm": {"no": 0, "eps": 0.2},
                             ...
                             "gn":{"no": 6, "std": 10},
                             "jitter":{"no": 7, "eps": 0.2, "alpha": 0.02, "steps": 50, "scale": 10, "std": 0.1, "random_start": True}}
    # 用于测试
    attack_type_num = 0
    ...
    # generator = train_Adv_WGAN.Train_Adv_WGAN(benign_normal_trainset_dataloader, benign_attack_trainset_dataloader, adv_normal_trainset_dataloader, adv_attack_trainset_dataloader, a=0.5, b=0.1, c=0.3, d=0.1)
    generator = task.train(benign_normal_trainset_dataloader, benign_attack_trainset_dataloader, adv_normal_trainset_dataloader, adv_attack_trainset_dataloader)
